...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-657-erd-s-problem-657-09dc568b-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-657"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-657-erd-s-problem-657-09dc568b-v1",
      "problem_contract_sha256": "71476404d2163b4aa60840f8c89714574756a9b3e80f64d174b87ed69508a399",
      "problem_id": "problem:um-ep-657-erd-s-problem-657-09dc568b",
      "route_id": "route:um-ep-657-erd-s-problem-657-09dc568b-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-657-erd-s-problem-657-09dc568b-source-fidelity-01",
      "graph_id": "graph:um-ep-657-erd-s-problem-657-09dc568b-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-657-erd-s-problem-657-09dc568b-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-657-erd-s-problem-657-09dc568b-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is it true that if $A\\subset \\mathbb{R}^2$ is a set of $n$ points such that every subset of $3$ points determines $3$ distinct distances (i.e. $A$ has no isosceles triangles) then $A$ must determine at least $f(n)n$ distinct distances, for some $f(n)\\to \\infty$?"
          },
          "statement_sha256": "604c71d8474ea8067a152e5b8a9a7c2c0bbcf05e8df616557bd4b608e9d05fa7"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-657-erd-s-problem-657-09dc568b-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-657-erd-s-problem-657-09dc568b-root",
      "route_id": "route:um-ep-657-erd-s-problem-657-09dc568b-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-657-235a51e9d629",
        "url": "https://www.unsolvedmath.com/problems/EP-657"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
